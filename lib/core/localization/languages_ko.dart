...
class LanguagesKo extends Languages {
  ...
  @override
  String get peaceCatDescription => '정면을 향한 귀. 세로로 찢어진 동공. 옆으로 뻗어진 수염.';
  @override
  String get yawnCatDescription => '고양이도 졸릴 때나 부족한 산소를 공급할 때 하품을 하는데요.';
  @override
  String get angryCatDescription => '한껏 뒤로젖혀진 두 귀. 찡그린 미간과 콧잔등. 슬쩍 보이는 송곳니.';
  @override
  String get sleepyCatDescription => '쿨쿨쿨...\n맨날 잠만 자는 듯한 주인님...';
  @override
  String get excitedCatDescription => '한껏 확장된 동공. 활짝 펼쳐진 수염. 꼿꼿하게 선 두 귀.';
  @override
  String get failedDescription => '죄송합니다... 알 수 없는 생물체 분석에 실패하였습니다...';
  @override
  String get peaceCatContents =>
      '무언가 맘에 안 드는 의뭉스러운 표정같다구요?? 주인님은 현재 마음의 평화를 찾았습니다. 매우 만족스러운 상태입니다.';
  @override
  ...
  String get angryCatContents =>
      '그 밖에도 긴장과 불안을 해소하기 위해서도 하품을 합니다. 하지만 과도한 하품은 구내염, 치주염 등 주인님 입안이 불편하다는 사인일 수도 있습니다!';
  @override
  ...
  String get failedContents =>
      '어떤 의미로는 굉장히 정상적인 상태입니다... 감히 한낱 인간이 어찌 고양이님의 위대한 기분을 헤아리겠습니까... 하하...\n주인님의 얼굴을 정면에서 잘 찍어서 다시 시도해 주세요:)';
  @override
  String get warning =>
